(() => {
  ...
  <p>Áp dụng Chủ nhật theo giờ Việt Nam. Khách thêm cả món mua và món tặng vào giỏ; phải đủ một bộ để nhận ưu đãi. Món tặng không tính vào số lượng phải mua. Topping tính riêng. Hệ thống chọn ưu đãi tốt nhất và tính giá vốn cả món tặng.</p>
  ...
  firebase.auth().onAuthStateChanged(user=>{
    ...
    off=db.collection('storeSettings').doc('appearance').onSnapshot(s=>{
      ...
      const o=a.sundayOffer||{};get('offerTitle').value=o.title||'Quà tặng Chủ nhật';get('offerBuyQty').value=o.buyQty||2;get('offerGiftQty').value=o.giftQty||1;get('offerRepeat').checked=o.repeat!==false;fillChoices();}
